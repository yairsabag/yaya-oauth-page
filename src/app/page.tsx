...
// Phone Mockup Component - נשאר זהה
    ...
    <div style={{ fontFamily: "system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
            ...
            {/* עדכון הלינקים להשתמש ב-buildUrlWithCode */}
            <a
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
          ...
          {/* עדכון הלינק */}
          <a href={buildUrlWithCode('/payment')} className="animate-on-scroll" style={{
            background: '#2d5016',
            color: 'white',
            padding: '16px 32px',
            borderRadius: '8px',
      ...
      {/* שאר הקוד נשאר זהה... Pricing Section, Footer, etc. */}
      {/* רק צריך לעדכן הלינקים ב-Footer להשתמש ב-buildUrlWithCode אם רלוונטי */}
