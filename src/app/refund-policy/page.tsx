export default function RefundPolicy() {
  return (
    <div style={{ maxWidth: 800, margin: '60px auto', padding: '0 2rem', fontFamily: 'system-ui, sans-serif' }}>
      <h1>Refund Policy</h1>
      ...
      <h2>Cancellations</h2>
      <p>You may cancel your Pro subscription at any time. Upon cancellation, your account will revert to the free Basic plan at the end of the current billing period. We do not provide partial refunds for unused subscription time.</p>

      <h2>Contact</h2>
      <p>For refund requests, please contact: <a href="mailto:support@yayagent.com">support@yayagent.com</a></p>
    </div>
  )
}
