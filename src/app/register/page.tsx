...
interface Plan {
  name: string
  monthlyPrice: number
  yearlyPrice: number   // מחיר חודשי אפקטיבי כשמשלמים שנתי (כמו שהגדרת)
  popular: boolean
  features: string[]
}
            ...
            <div style={{ maxWidth: 600, margin: '0 auto', textAlign: 'center' }}>
              ...
              >
                <svg width="20" height="20" viewBox="0 0 24 24">
                  ...
                  <path
                    fill="white"
                    d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93ל2.85-2.22.81-.62z"
                  />
                  <path
                    fill="white"
                    d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07ל3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"
                  />
                </svg>
