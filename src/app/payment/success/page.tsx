...
export default function CheckoutPage() {
  ...
  // פרטי הלקוח (מועברים ל-Tranzila כ-metadata)
  ...
  useEffect(() => {
    ...
    setUrlParams({
      plan: (p.get('plan') || 'executive').toLowerCase(),
      price: p.get('price') || '5',
  ...
  // בניית URL בסגנון הדוגמה שלהם (GET params), אבל עם הפרמטרים שלנו
  const iframeSrc = useMemo(() => {
    ...
    const params = new URLSearchParams({
      ...
      // כתובות חזרה/notify (להחליף לנתיבי הפרודקשן שלך)
          ...
          <section>
            ...
            >
              {isLoading || !readyForIframe ? (
                ...
                <iframe
                  key={iframeSrc /* רענון כשפרמטרים משתנים */}
                  src={iframeSrc}
